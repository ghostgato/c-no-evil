...
UnityPrintFloat (const UNITY_DOUBLE input_number)
{
    ...
    else
    {
        ...
        UNITY_DOUBLE diff = (UNITY_DOUBLE)n - number;
        if ((n & 1) && (0.5 - epsilon < diff) && (diff < 0.5 + epsilon))
            n--;
#endif
